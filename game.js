...
const spanRecord = document.querySelector('#record');//Para mostra el tiempo
const pResult = document.querySelector('#result'); // este se crea asi porque no tiene span
/* const pPerdiste = document.querySelector('#Perdiste'); */


const Alerta = 'Perdiste, Intentalo de nuevo';

const Happy = 'Ganaste felicidades 🎉';
...
window.addEventListener('load', setCanvasSize);// Para qyue cargue el HTML y el juego aparezca
...
function setCanvasSize() {
  if (window.innerHeight > window.innerWidth) {
    canvasSize = window.innerWidth * 0.7;//estos es para canva si lo pones mas pequeño no coje bien 
  } else {
